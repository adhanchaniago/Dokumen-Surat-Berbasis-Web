...
<footer class="page-footer">
    ...
    <div class="footer-copyright teal white-text">
            ...
            <div class="right hide-on-small-only">
                <?php
                    if(!empty($data['website'])){
                        ...
                        echo '<i class="material-icons md-12">public</i> www.smptamhar.sch.id &nbsp;&nbsp;';
                    }
                    if(!empty($data['email'])){
                        echo '<i class="material-icons">mail_outline</i> '.$data['email'].'';
                    } else {
                        echo '<i class="material-icons">mail_outline</i>  info@smptamhar.sch.id';
                    }
                }
                ?>
            </div>
