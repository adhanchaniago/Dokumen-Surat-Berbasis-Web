        ...
        <div class="container">
            <div id="colres">
                <div class="disp">';
                    ...
                    if(!empty($logo)){
                        ...
                        echo '<img class="logodisp" src="./images/logo-tamhar.png"/>';
                    }
                    if(!empty($institusi)){
                        echo '<h6 class="up">'.$institusi.'</h6>';
                    } else {
                        echo '<h6 class="up">Yayasan Pendidikan Islam Swasembada</h6>';
                    }
                    if(!empty($nama)){
                        echo '<h5 class="up" id="nama">'.$nama.'</h5><br/>';
                    } else {
                        echo '<h5 class="up" id="nama">SMP Taman Harapan Bekasi</h5><br/>';
                    }
                    if(!empty($status)){
                    ...
                    if(!empty($alamat)){
                        ...
                        echo '<span id="alamat">Perumahan Taman Harapan Baru, Pejuang, Medan Satria, Kota Bks, Jawa Barat 17131</span>';
                    }
                    echo '
                </div>
            ...
            <div id="lead">
                ...
                if(!empty($kepsek)){
                    ...
                    echo '<p class="lead">H. M.Haris Zakarsih.M.A. </p>';
                }
                if(!empty($nip)){
                    echo '<p>NIP. '.$nip.'</p>';
                } else {
